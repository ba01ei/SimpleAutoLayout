#
#  Be sure to run `pod spec lint SimpleAutoLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ba01ei/SimpleAutoLayout.git", :tag => "0.1.0" }
  ...
  s.source_files  = "SimpleAutoLayout/**/*.{swift}"
